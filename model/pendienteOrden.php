...
class PendienteOrden
{
  ...
  public function __CONSTRUCT()
   ...
   {
     $sql = $this->conn->prepare("UPDATE pendienteOrden set entregado = 2, src_imagen =?, rut_receptor = ? where id_orden = ? ");
     $sql->execute(array($a->src_imagen, $a->rut_receptor,$a->id_orden));
