...
">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo text-center">
                <a href="?c=Usuario&a=Dashboard" class=" text-center" style="color:black; font-weight: bold;">
                    <img src="../view/images/logo2.png" alt="" style="POSITION: RELATIVE; top: -9px; width:30px; margin-top:20px;left: 77px;" />
                    <label style="color:#fff;  font-family: sans-serif; position: relative; top: 10px; left: 30px; font-size:15px;"></label><br>
    ...
    padding-left: 12px;
    border-radius: 20px 0px 20px 20px;
    box-shadow: 0px 4px 40px rgba(0, 0, 0, 0.25);margin-top: 15px;">
                            <a class="js-arrow" href="#">
    ...
    padding-left: 12px;
    border-radius: 20px 0px 20px 20px;
    box-shadow: 0px 4px 40px rgba(0, 0, 0, 0.25);margin-top: 15px;margin-bottom: 15px;">
                            <a class="js-arrow" href="#">
                        ...
                        <li class="active has-sub btn btn-danger"style="border-radius: 20px 0px 20px 20px;
    box-shadow: 0px 4px 40px rgba(0, 0, 0, 0.25);
    background: #FF0000;
}">
